...
namespace SeleniumTests
{
    ...
    public class CompareList
    {
        ...
        [Test]
        public void TheCompareListTest()
        {
            driver.Navigate().GoToUrl("https://demowebshop.tricentis.com/login");
            driver.FindElement(By.Id("Email")).Click();
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("dorijan.osmakcic135@gmail.com");
            driver.FindElement(By.Id("Password")).Click();
            driver.FindElement(By.Id("Password")).Clear();
            driver.FindElement(By.Id("Password")).SendKeys("dorijan555");
